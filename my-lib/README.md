...
```
npm install my-test-lib@1.0.0 --save
```
...
import { ApiModule, Configuration, ConfigurationParameters } from 'my-test-lib';
...
```
import { DefaultApi } from 'my-test-lib';
...
```
import { BASE_PATH } from 'my-test-lib';
